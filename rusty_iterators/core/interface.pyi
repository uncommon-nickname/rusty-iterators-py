...
AllCallable: TypeAlias = Callable[[T], bool]
AnyCallable: TypeAlias = AllCallable[T]
...
class IterInterface(Generic[T]):
    ...
    def all(self, f: AllCallable[T] | None = None) -> bool: ...
    def any(self, f: AnyCallable[T] | None = None) -> bool: ...
